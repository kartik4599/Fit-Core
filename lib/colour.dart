...
class AppColor {
  ...
  static Color homePagesContainerTextbig = const Color(0xFFffffff);
  ...
  static Color secondPageContainerGradient1stColor = const Color(0xFF0a54ff);
  static Color secondPageContainerGradient2stColor = const Color(0xFF4166f5);
